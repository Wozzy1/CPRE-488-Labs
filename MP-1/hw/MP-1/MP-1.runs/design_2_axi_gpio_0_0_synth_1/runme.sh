...
HD_PWD='C:/Users/cihem/CPRE-488-Labs/MP-1/hw/MP-1/MP-1.runs/design_2_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_axi_gpio_0_0.tcl
