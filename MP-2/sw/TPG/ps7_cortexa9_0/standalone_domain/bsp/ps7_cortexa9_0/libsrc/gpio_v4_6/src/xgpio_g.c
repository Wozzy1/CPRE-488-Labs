...
{
	{
		XPAR_AXI_CAMA_BTA_DEVICE_ID,
		XPAR_AXI_CAMA_BTA_BASEADDR,
		XPAR_AXI_CAMA_BTA_INTERRUPT_PRESENT,
		XPAR_AXI_CAMA_BTA_IS_DUAL
	},
	{
		XPAR_AXI_CAMA_GPIO_DEVICE_ID,
		XPAR_AXI_CAMA_GPIO_BASEADDR,
		XPAR_AXI_CAMA_GPIO_INTERRUPT_PRESENT,
		XPAR_AXI_CAMA_GPIO_IS_DUAL
	},
	{
