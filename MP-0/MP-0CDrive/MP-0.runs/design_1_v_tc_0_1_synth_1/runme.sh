...
HD_PWD='C:/Users/cihem/test/CPRE-488-Labs/MP-0/MP-0CDrive/MP-0.runs/design_1_v_tc_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_v_tc_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_v_tc_0_1.tcl
