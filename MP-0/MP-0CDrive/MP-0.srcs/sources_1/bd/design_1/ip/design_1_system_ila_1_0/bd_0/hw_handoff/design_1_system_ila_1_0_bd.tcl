...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net SLOT_0_VIDEO_TIMING_active_video_1 [get_bd_ports SLOT_0_VIDEO_TIMING_active_video] [get_bd_pins ila_lib/probe4]
  connect_bd_net -net SLOT_0_VIDEO_TIMING_hblank_1 [get_bd_ports SLOT_0_VIDEO_TIMING_hblank] [get_bd_pins ila_lib/probe5]
  connect_bd_net -net SLOT_0_VIDEO_TIMING_hsync_1 [get_bd_ports SLOT_0_VIDEO_TIMING_hsync] [get_bd_pins ila_lib/probe6]
  connect_bd_net -net SLOT_0_VIDEO_TIMING_vblank_1 [get_bd_ports SLOT_0_VIDEO_TIMING_vblank] [get_bd_pins ila_lib/probe7]
  connect_bd_net -net SLOT_0_VIDEO_TIMING_vsync_1 [get_bd_ports SLOT_0_VIDEO_TIMING_vsync] [get_bd_pins ila_lib/probe8]
