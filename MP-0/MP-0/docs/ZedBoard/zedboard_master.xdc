...
# VGA Output - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y21  [get_ports {Dout_0[0]}];  # "VGA-B1"
set_property PACKAGE_PIN Y20  [get_ports {Dout_0[1]}];  # "VGA-B2"
set_property PACKAGE_PIN AB20 [get_ports {Dout_0[2]}];  # "VGA-B3"
set_property PACKAGE_PIN AB19 [get_ports {Dout_0[3]}];  # "VGA-B4"
...
set_property PACKAGE_PIN V20  [get_ports {Dout_2[0]}];  # "VGA-R1"
set_property PACKAGE_PIN U20  [get_ports {Dout_2[1]}];  # "VGA-R2"
set_property PACKAGE_PIN V19  [get_ports {Dout_2[2]}];  # "VGA-R3"
set_property PACKAGE_PIN V18  [get_ports {Dout_2[3]}];  # "VGA-R4"
